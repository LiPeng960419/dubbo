package com.lipeng.common.catmonitor.registry;
...
import com.lipeng.common.catmonitor.constants.CatConstants;
	...
	class RegistryWrapper implements Registry {
		...
		private URL appendProviderAppName(URL url) {
			...
			if (Constants.PROVIDER_SIDE.equals(side)) {
				url = url.addParameter(CatConstants.PROVIDER_APPLICATION_NAME,
